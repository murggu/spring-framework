package com.aitormurguzur.spring.data.core.domain.fixtures;
...
import com.aitormurguzur.spring.data.core.domain.*;
import com.aitormurguzur.spring.data.events.orders.OrderDetails;

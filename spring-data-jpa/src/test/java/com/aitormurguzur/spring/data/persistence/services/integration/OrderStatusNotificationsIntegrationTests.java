...
import com.aitormurguzur.spring.data.persistence.integration.fakecore.CountingOrderStatusService;
...
public class OrderStatusNotificationsIntegrationTests {
	...
	public void thatCQNotificationsPropogateToCore() throws Exception {
		...
		assertTrue("Did not send enough notifications within timeout",

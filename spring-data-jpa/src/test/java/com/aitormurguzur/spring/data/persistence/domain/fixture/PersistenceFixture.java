package com.aitormurguzur.spring.data.persistence.domain.fixture;

import java.math.BigDecimal;
import java.util.*;

import com.aitormurguzur.spring.data.persistence.domain.Ingredient;
...
public class PersistenceFixture {
	...
	public static MenuItem standardItem() {
		...
		item.setIngredients(new HashSet<Ingredient>(Arrays.asList(
				...
				new Ingredient("Egg", "Used in the noodles"), new Ingredient(
						"Peanuts", "A Nut"))));
